...
from ugc_service.src.core.config import jwt_settings
from ugc_service.src.models.auth_models import HTTPTokenAuthorizationCredentials, AccessTokenPayload
